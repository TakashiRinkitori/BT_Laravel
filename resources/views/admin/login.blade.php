...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="{{asset('client/img/icon_me.webp')}}">
...
<body class="bg-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" action="{{ route('admin.login') }}" autocomplete="off" method="POST">
                                        @csrf
                                        <div class="form-group">
                                            ...
                                            name="email" class="form-control form-control-user" placeholder="Email đăng nhập...">
                                        </div>
                                        <div class="form-group">
                                            <input type="password" data-validation="length" data-validation-length="min1" data-validation-error-msg="Vui lòng nhập mật khẩu!"
                                            name="password" class="form-control form-control-user" placeholder="Mật khẩu...">
                                        </div>
    ...
    <!-- Form validator -->
    <script src="{{asset('server/js/jquery.form-validator.min.js')}}"></script>
